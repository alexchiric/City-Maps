...
export default function Legend() {
  return (
    ...
    <div className="absolute right-4 bottom-10 z-10 rounded-lg bg-white/95 p-3 text-xs text-zinc-700 shadow-lg backdrop-blur-sm dark:bg-zinc-900/95 dark:text-zinc-300">
      <div className="mb-1 font-medium text-zinc-800 dark:text-zinc-100">Livability score</div>
